...
<html lang="en">
  <head>
    ...
    <title>CoVid-19 Consultation</title>
        ...
        <div class="container-fluid" style="padding-left:30px;margin-top: -15px">
          <div class="border-bottom">  
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">  
              <h2 style="margin-top: 35px;margin-bottom: 15px; color: #23467a;">COVID-  19 Consultation</h2>
            </div>
            <p class="text-muted" style="margin-top:-12px">Have a quick consultation about Covid-19 disease</p>
          </div>
