...
$results = mysqli_query($conn, "SELECT * FROM appointment apt WHERE apt.patient_id = $id ORDER BY apt_date, apt_time");
?>
  ...
  <main>
    ...
    <div class="d-flex flex-column flex-shrink-0 m-md-0 text-white" style="width: 310px; background-color: #23467a;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <hr class="dropdown-divider" style="color: #e1eaf7; height: 2px; margin: 10px">
        </li>
        <li class="nav_item">
          <a href="https://consultation19-react.herokuapp.com/consultation/<?php echo $_SESSION['unique_id']; ?>" target="_blank" class="nav-link " style="color: #ffffff;">
